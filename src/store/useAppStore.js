...
export const TRAIL_POIS = [
  ...
  // --- ÉPICERIES & RAVITAILLEMENTS ALIMENTAIRES ---
  {
    id: 'poi-epicerie-rap',
    name: 'Dépanneur & Alimentation Rivière-à-Pierre',
    km: 'Km 68 (Départ J1)',
    type: 'grocery',
    hasWater: true,
    hasToilets: false,
    hasRepair: false,
    hasParking: true,
    coordinates: [46.990150, -72.181200],
    address: 'Rue de la Gare, Rivière-à-Pierre',
    distanceFromTrail: 'À 150m de la gare',
    role: 'Derniers achats avant la zone blanche du Lac Simon',
    description: 'Épicerie de village : boissons, collations énergétiques, glace et provisions d\'appoint avant d\'entrer en zone forestière.'
  },
  {
    id: 'poi-epicerie-st-leonard',
    name: 'Dépanneur Accommodation Saint-Léonard',
    km: 'Km 48.5 (Étape J1)',
    type: 'grocery',
    hasWater: false,
    hasToilets: false,
    hasRepair: false,
    hasParking: true,
    coordinates: [46.897450, -72.028900],
    address: 'Rue Principale, Saint-Léonard-de-Portneuf',
    distanceFromTrail: 'À 300m de la piste / Lac Simon',
    role: 'Appoint bivouac Lac Simon',
    description: 'Dépanneur de proximité pour le camping du Lac Simon : collations, boissons et glace.'
  },
  {
    id: 'poi-epicerie-metro-st-raymond',
    name: 'Metro Plus Saint-Raymond',
    km: 'Km 31 (Étape J2)',
    type: 'grocery',
    hasWater: true,
    hasToilets: true,
    hasRepair: false,
    hasParking: true,
    coordinates: [46.885820, -71.828550],
    address: '300 Rue Saint-Joseph, Saint-Raymond, QC G3L 1J9',
    distanceFromTrail: 'À 400m de la gare de la Vélopiste',
    role: 'POINT OFFICIEL REFILL J2 (Souper J2 + Déjeuner & Dîner J3)',
    description: 'Grand supermarché complet : fruits frais, viandes, boulangerie, comptoir prêt-à-manger et provisions du Refill J2.'
  },
  {
    id: 'poi-epicerie-iga-st-raymond',
    name: 'IGA Extra Saint-Raymond',
    km: 'Km 31 (Étape J2)',
    type: 'grocery',
    hasWater: true,
    hasToilets: true,
    hasRepair: false,
    hasParking: true,
    coordinates: [46.897210, -71.838420],
    address: '150 Côte Joyeuse, Saint-Raymond, QC G3L 4T4',
    distanceFromTrail: 'À 1.2 km du centre',
    role: 'Alternative complète Refill J2',
    description: 'Grand supermarché avec comptoir traiteur et vaste choix de produits frais et boissons.'
  },
  {
    id: 'poi-epicerie-iga-ste-catherine',
    name: 'IGA Sainte-Catherine-de-la-JCP',
    km: 'Km 14 (Mi-parcours J3)',
    type: 'grocery',
    hasWater: true,
    hasToilets: true,
    hasRepair: false,
    hasParking: true,
    coordinates: [46.851900, -71.614500],
    address: '4521 Route de Fossambault, Sainte-Catherine',
    distanceFromTrail: 'À 600m de la halte Duchesnay',
    role: 'Halte mi-parcours J3 (Pique-nique & Collation)',
    description: 'Supermarché complet sur la route de Fossambault : halte fraîcheur idéale pour ravitailler avant la montée vers Shannon.'
  },
  {
    id: 'poi-epicerie-metro-val-belair',
    name: 'Metro Plus Val-Bélair',
    km: 'Étape J3 (Piste Cheminots)',
    type: 'grocery',
    hasWater: true,
    hasToilets: true,
    hasRepair: false,
    hasParking: true,
    coordinates: [46.845600, -71.439800],
    address: '1145 Boulevard Pie-XI Sud, Québec, QC G3J 0E1',
    distanceFromTrail: 'À 500m de la piste des Cheminots',
    role: 'POINT OFFICIEL REFILL J3 (Souper J3 + Journée J4)',
    description: 'Supermarché urbain complet pour les achats de fin d\'étape J3 et le pique-nique final du J4.'
  },
  {
    id: 'poi-epicerie-iga-monument',
    name: 'IGA Extra Beauport (Avenue du Monument)',
    km: 'Arrivée J4',
    type: 'grocery',
    hasWater: true,
    hasToilets: true,
    hasRepair: false,
    hasParking: true,
    coordinates: [46.852400, -71.205200],
    address: 'Avenue du Monument / Boul. Sainte-Anne, Québec',
    distanceFromTrail: 'À 400m de la ligne d\'arrivée',
    role: 'Pique-nique de célébration d\'arrivée',
    description: 'Supermarché à proximité immédiate du 1937 avenue du Monument pour fêter l\'arrivée de l\'expédition Vélococos !'
  }
];
...
export const useAppStore = create(
  persist(
    (set, get) => ({
      ...
      updateItemNote: (listName, itemId, note) => {
        set((state) => {
          const targetList = state[listName];
          if (!targetList) return state;

          const updatedList = targetList.map((item) =>
            item.id === itemId ? { ...item, note: note ? note.trim() : '' } : item
          );
